...
1.Pipeline installation and data preparation
```
# installing minicoda 
...
```
```
# preparing the demultiplexed data (without barcode and primer), the reads length is around 200bp
# moving all the R1.fastq.gz and R2.fastq.gz files in one folder
...
trimming low quality bp ,generating feature table and representative sequences
```
